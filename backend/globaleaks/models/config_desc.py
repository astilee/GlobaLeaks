...
ConfigDescriptor = {
    ...
    'threshold_api_read_requests_per_second_per_ip': Int(default=20),
    'threshold_api_write_requests_per_second_per_ip': Int(default=20),
    'threshold_get_requests_per_second_per_ip': Int(default=20),
    'threshold_reports_per_hour_per_ip': Int(default=5),
